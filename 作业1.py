...
sum=(253.6*(10+69+140+10+10)+86.3*(60+72+35+90+60+60+140)+96.8*(10+25+43+60+43+78)+135.9*(63+24+63+57)+65.8*(63+45+129+63+58+48+63)+49.3*120)
print("您的总销售额为:",sum)
zxssl=(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30
print("您的平均每日销售数量为:",zxssl)
yrf=239#羽绒服月销售总额
nzk=482#牛仔裤月销售总额
pc=207#皮草月销售总额
Tx=469#T血月销售总额
...
fy=292#风衣月销售总额
zh=1809#总销售额
print("羽绒服月销售总额",'%.2f%%'%(yrf/zh*100))
print("牛仔裤月销售总额",'%.2f%%'%(nzk/zh*100))
print("皮草月销售总额",'%.2f%%'%(pc/zh*100))
print("T血月销售总额",'%.2f%%'%(Tx/zh*100))
print("衬衫月销售总额",'%.2f%%'%(cs/zh*100))
print("风衣月销售总额",'%.2f%%'%(fy/zh*100))
input("")
